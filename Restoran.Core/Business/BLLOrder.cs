...
{
    public class BLLOrder // Sınıf adı BLLOrder olarak değiştirildi
    {
        public BLLOrder()
        {
        ...
        public async Task<(bool Success, string Message)> CreateOrderAsync(OrderCreateDto dto)
        {
            ...
            // 1. Sipariş boş mu kontrolü
            if (dto.Items == null || dto.Items.Count == 0)
                return (false, "Sipariş boş olamaz");

            // 2. Her ürün için stok ve aktiflik kontrolü
            ...
            // Tüm kontroller geçti, sipariş oluştur
            var order = new Order
            {
                UserId = dto.UserId,
            ...
            // Stok güncelle ve sipariş detayları ekle
            foreach (var item in dto.Items)
            {
                // Stok azalt
